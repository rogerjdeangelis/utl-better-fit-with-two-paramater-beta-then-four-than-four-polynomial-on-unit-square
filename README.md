# utl-better-fit-with-two-paramater-beta-then-four-than-four-polynomial-on-unit-square
Better fit with two paramater beta then four than four polynomial on unit square
    ...
    https://github.com/rogerjdeangelis/utl-better-fit-with-two-paramater-beta-then-four-than-four-polynomial-on-unit-square/blob/main/pltcum

    github
    https://tinyurl.com/54kd3y3v
